...
Overall deterministic same-budget Top-1: 46/65; sampled Top-1: 32/65. Deterministic reference rank samples: 65; sampled reference rank samples: 61.
...
Machine-readable output: `professional-endgame-comparison-current-v3.json`
